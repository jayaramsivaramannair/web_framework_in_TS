...
var CollectionView = function () {
  ...
  CollectionView.prototype.render = function () {
    //set the parent property to be an empty string
...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "/Users/jayaramnair/Desktop/Github Repos/web_framework_in_TS",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
var Model = function () {
  ...
  Model.prototype.set = function (update) {
    this.attributes.set(update); //When the properties of a user instance are updated or initialized, a change event will also be triggered
...
var axios_1 = __importDefault(require("axios")); //T extends HasId suggests that any object which Class Sync is equipped to handle will have an id property
...
var ApiSync = function () {
  ...
  ApiSync.prototype.save = function (data) {
    ...
    var id = data.id; //If the user already exists then simply update the user by making a put request
...
users.fetch();
},{"./views/UserList":"src/views/UserList.ts","./models/Collection":"src/models/Collection.ts","./models/User":"src/models/User.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
